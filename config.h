...
DECLARE_PARAM(  CENTER_ATTACKS,                      51,    0,     100)
DECLARE_PARAM(  CENTER_OCCUPANCY,                   108,    0,     300)
...
DECLARE_VALUE(  MIDGAME_HALF_OPEN_FILE,             135,    0,     250)
DECLARE_VALUE(  MIDGAME_OPEN_FILE,                  105,    0,     250)
DECLARE_VALUE(  MIDGAME_PASSED_FORMATION,            18,    0,     100)
DECLARE_VALUE(  MIDGAME_PAWN_CHAIN,                  21,    0,     100)
DECLARE_VALUE(  MIDGAME_PAWN_MAJORITY,               14,    0,     250)
