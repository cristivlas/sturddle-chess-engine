...
DECLARE_VALUE(  DOUBLE_EXT_MARGIN,                  142,    0,    1000)
...
DECLARE_VALUE(  ENDGAME_PASSED_FORMATION,           100,    0,     250)
DECLARE_VALUE(  ENDGAME_PAWN_MAJORITY,               73,    0,     250)
DECLARE_VALUE(  ENDGAME_UNBLOCKED_PASSED_6,         140,    0,     250)
