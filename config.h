...
GROUP(Search)
DECLARE_VALUE(  DOUBLE_EXT_MARGIN,                  844,  500,    1000)
...
DECLARE_VALUE(  MULTICUT_MARGIN_LOW,                105,   50,     350)
DECLARE_VALUE(  MULTICUT_MARGIN_HIGH,               667,  500,    1000)
...
GROUP(MoveOrdering)
DECLARE_VALUE(  COUNTER_MOVE_BONUS,                 271,    0,     500)
