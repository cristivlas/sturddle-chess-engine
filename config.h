...
GROUP(Search)
DECLARE_VALUE(  DOUBLE_EXT_MARGIN,                  874,  500,    1000)
DECLARE_VALUE(  DOUBLE_EXT_MAX,                       9,    0,     100)
DECLARE_VALUE(  LMP_BASE,                             2,    2,     100)
DECLARE_VALUE(  LATE_MOVE_REDUCTION_COUNT,            4,    0,     100)
DECLARE_PARAM(  MIN_EXT_DEPTH,                        7,    0,     100)
DECLARE_VALUE(  MULTICUT_COMPLEXITY_THRESHOLD,       32,    0,     100)
DECLARE_VALUE(  MULTICUT_MARGIN_LOW,                 95,   50,     350)
DECLARE_VALUE(  MULTICUT_MARGIN_HIGH,               660,  500,    1000)
...
DECLARE_PARAM(  TIME_CTRL_EVAL_THRESHOLD,           -50, -150,       0)

GROUP(MoveOrdering)
DECLARE_VALUE(  COUNTER_MOVE_BONUS,                 333,    0,     500)
