...
DECLARE_VALUE(  NULL_MOVE_DEPTH_FACTOR,               2,    1,     100)

#if ADAPTIVE_NULL_MOVE
DECLARE_VALUE(  NULL_MOVE_FACTOR,                   468,    1,    1000)
...
DECLARE_VALUE(  KING_ATTACK_FACTOR,                  28,    1,     100)
...
DECLARE_VALUE(  ENDGAME_THREATS,                     41,    0,     250)
...
DECLARE_VALUE(  MIDGAME_THREATS,                     18,    0,     250)
