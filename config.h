...
DECLARE_VALUE(  MULTICUT_COMPLEXITY_THRESHOLD,       50,    0,     100)
DECLARE_VALUE(  MULTICUT_MARGIN_LOW,                155,    0,    1000)
DECLARE_VALUE(  MULTICUT_MARGIN_HIGH,               827,    0,    1000)
...
DECLARE_VALUE(  HISTORY_COUNT_HIGH,               85305,    1,  100000)
DECLARE_VALUE(  HISTORY_SCORE_DIV,                   43,    1,     100)
DECLARE_VALUE(  HISTORY_FAIL_LOW_MARGIN,           1175,    0,    2000)
DECLARE_VALUE(  HISTORY_FAIL_LOW_PENALTY,            60,    0,     100)
