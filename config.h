...
GROUP(Search)
DECLARE_VALUE(  DOUBLE_EXT_MARGIN,                  185,    0,    1000)
DECLARE_VALUE(  DOUBLE_EXT_MAX,                       6,    0,     100)
DECLARE_VALUE(  HISTORY_BONUS_MARGIN,               110,    0,    1000)
DECLARE_VALUE(  IMPROVEMENT_EXT_DIV,                349,    1,    1000)
...
DECLARE_VALUE(  ENDGAME_PASSED_FORMATION,            30,    0,     100)
DECLARE_VALUE(  ENDGAME_PAWN_CHAIN,                   5,    0,     100)
DECLARE_VALUE(  ENDGAME_PAWN_MAJORITY,               58,    0,     250)
...
DECLARE_VALUE(  MIDGAME_PASSED_FORMATION,            61,    0,     100)
DECLARE_VALUE(  MIDGAME_PAWN_CHAIN,                  17,    0,     100)
