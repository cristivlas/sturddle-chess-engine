...
DECLARE_CONST(  FULL_WINDOW_RESET,                    1,    0,       1)
...
DECLARE_VALUE(  CENTER_OCCUPANCY,                   108,    0,     150)
...
DECLARE_VALUE(  MIDGAME_HALF_OPEN_FILE,             141,    0,     250)
DECLARE_VALUE(  MIDGAME_OPEN_FILE,                  102,    0,     250)
