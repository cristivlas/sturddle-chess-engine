...
DECLARE_VALUE(  HISTORY_PRUNE,                       38,    0,     100)
...
DECLARE_VALUE(  NULL_MOVE_MARGIN,                   102,    0,    1000)
...
GROUP(MoveOrdering)
DECLARE_VALUE(  COUNTER_MOVE_BONUS,                 280,    0,     500)
...
DECLARE_VALUE(  HISTORY_LOW,                         11,    0, HISTORY_HIGH)
